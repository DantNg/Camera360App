...
void main() {
  test('listFiles', () async {
    ...
    infoList.add(FileInfo(
      name,
      'http://192.168.0.194/files/150100524436344d4201375fda9dc400/100RICOH/R0013336.JPG',
      100,
      ...
      1000,
      500,
      'http://192.168.0.194/files/150100524436344d4201375fda9dc400/100RICOH/R0013336.JPG?type=thumb',
      'id_intervalCaptureGroupId',
      'id_compositeShootingGroupId',
      'id_autoBracketGroupId',
      2,
      true,
      'http://192.168.0.194/preview',
